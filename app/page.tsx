          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            {mode === 'signup' && (
              <input
                ...
                required
                className="w-full h-10 px-3 text-[13px] border border-[#E5E5E5] rounded-xl outline-none focus:border-[#2D5219] placeholder:text-[#DADADA] transition-colors"
              />
            )}
            <input
              type="email"
            ...
            {success && (
              <p className="text-[12px] text-[#2D5219] bg-[#F4F9F0] px-3 py-2 rounded-lg">
                {success}
              </p>
            )}
